<script>
  ...
  import Quantity from "~/sections/cart/Quantity.svelte";
...
<div class="product">
  <div class="product-info">
    ...
    <div class="content">
      ...
      <p class="meta">
        <span class="color" style="--color: {meta.color}">{meta.color}</span>
        <span>{meta.color}</span>, <span>size {meta.size}</span>
      </p>
